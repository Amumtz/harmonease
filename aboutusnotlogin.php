...
<body class="bg-gray-50 text-gray-800" style="font-family: 'Kanit', sans-serif;">
    <header class="fixed w-full top-0 left-0 bg-white shadow z-50">
        ...
        <ul class="flex space-x-4">
            <li><a href="indexnotlogin.php" class="font-medium hover:text-blue-700">Home</a></li>
            <li><a href="aboutusnotlogin.php" class="font-medium hover:text-blue-700">About</a></li>
            <li><a href="#" class="font-medium hover:text-blue-700">Contact</a></li>
        </ul>
        <!-- Menu Navigasi -->
        <nav class="w-full sm:w-auto flex flex-wrap sm:flex-nowrap items-center mt-4 sm:mt-0">
            <a href="login.php"><button class="px-4 py-1 bg-blue-400 text-white rounded-full hover:bg-blue-500 transition">login</button></a>
            <!-- Garis Vertikal -->
            <div class="w-px h-6 bg-gray-300 mx-2 hidden sm:block"></div>
            <a href="daftar.php"><button class="ml-2 px-4 py-1 border-2 border-blue-400 text-blue-400 rounded-full hover:border-blue-500">
                registrasi
            </button></a>        
        </nav>
        </div>
