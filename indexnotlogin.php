...
<body class="max-width-full" style="font-family: 'Kanit', sans-serif;">  
    <header class="fixed-top bg-white shadow-sm">
        <div class="container py-3 d-flex flex-wrap justify-content-between align-items-center">
            <!-- Logo dan Nama -->
            <div class="d-flex align-items-center gap-2">
                <img src="img/logofull2.png" alt="Logo HarmonEasee" class="rounded-circle" style="width: 32px; height: 32px;">
                <span class="fw-semibold fs-5">HarmonEasee</span>
            </div>
            <!-- Menu Navigasi -->
            <ul class="nav">
                <li class="nav-item"><a href="indexnotlogin.php" class="nav-link text-body">Home</a></li>
                <li class="nav-item"><a href="aboutusnotlogin.php" class="nav-link text-body">About</a></li>
                <li class="nav-item"><a href="#" class="nav-link text-body">Contact</a></li>
            </ul>
            <nav class="d-flex align-items-center">
                <a href="login.php"><button class="btn btn-primary me-2">Login</button></a>
                <div class="vr d-none d-sm-block"></div>
                <a href="daftar.php"><button class="btn btn-outline-primary ms-2">Registrasi</button></a>
            </nav>
        </div>
    </header>
    ...
    <main class="width: 100%; padding: 0;">
                            ...
                            <div class="col-md-4">
                                <div class="card text-center shadow-sm border-3 h-100">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text mb-2 text-muted">Tes ini menilai tingkat kecemasan dan gejala yang terkait, seperti rasa khawatir berlebihan, ketegangan otot, dan kesulitan berkonsentrasi</p>
                            ...
                            <div class="col-md-4">
                                <div class="card text-center shadow-sm border-3 h-100">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text mb-2 text-muted line-clamp-5">Tes ini mengukur tingkat gejala depresi, seperti perasaan sedih yang mendalam, kehilangan minat dalam aktivitas, perubahan pola tidur, dan nafsu makan </p>
                                        <button class="btn btn-primary btn-sm mt-auto">Selengkapnya</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card text-center shadow-sm border-3 h-100">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text mb-2 text-muted">Tes ini mengevaluasi tingkat stres Anda dan dampaknya terhadap kesejahteraan fisik dan mental Anda. Dengan mengetahui tingkat stres</p>
                                        <button class="btn btn-primary btn-sm mt-auto">Selengkapnya</button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container-fluid mb-5">
            <h2 class="fw-bold text-primary mb-2 text-2xl">Rekomendasi Wisata</h2>
            <div class="row">
        ...
        <button type="button" class="me-1"><a href="#" class="text-secondary ">Lihat semua</a></button>
        </div>
        ...
        <div class="container-fluid px-4 pt-5 lg:px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-2">
                ...
                <div class="col-span-1 ml-10 mb-6">
                    ...
                    <ul class="space-y-2">
                        <li><a href="aboutusnotlogin.php" class="text-gray-400 hover:text-gray-700">About Us</a></li>
